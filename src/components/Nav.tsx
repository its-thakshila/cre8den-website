    ...
    <>
      ...
      <header className="sticky top-0 z-50 bg-white border-b border-border">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between gap-6">
          <button onClick={() => go("/")} className="flex flex-col items-center justify-center flex-shrink-0 text-muted-foreground hover:text-primary transition-colors">
            <Cre8denMark className="h-6" />
            <svg viewBox="0 0 250 12" width="100%" height="100%" className="w-[66%] h-auto mt-[3px]" preserveAspectRatio="none">
